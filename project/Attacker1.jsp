  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <h2>Attacker</h2>
          <p><form action="Attacker2.jsp" method="post" name="form1" id="form1">
<table border="0" align="center">
	<tr>
		...
		<td>&nbsp;</td>
       	...
       	<tr>
		<td width="223"><div align="center" class="style3"><span class="style7">Image Name </span></div></td>
		<td width="245"><label> <input required name="iname"type="text"  size="25" /> </label></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td><div align="center" class="style3"><span class="style7">Attacker  Name </span></div></td>
		<td><input name="aname" type="text" size="25" /></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	...
	<tr>
		<td><div align="right"><input type="submit" name="Submit"value="Attack" /></div>		</td>
	</tr>
          </table>
                </form>		  </p>
          <div class="clr"></div>
