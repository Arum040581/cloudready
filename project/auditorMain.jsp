  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <h2>Welcome to <span class="style4"><%=(String)application.getAttribute("auditor")%> </span>main Page..! </h2>
          <p><img src="images/Auditor.png" width="538" height="277" /></p>
          <p>&nbsp;</p>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="a_ViewImageFiles.jsp">View all image Files</a></li>
            <li><a href="a_AllAttackers.jsp">View all attackers</a></li>
