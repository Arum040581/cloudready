    ...
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          ...
          <p><form action="c_InsertData.jsp" method="post" id="sendemail" enctype="multipart/form-data">
            <ol>
              <li>
			  ...
			  <li>
                <label for="pic"><span class="style2">Select Profile Picture</span> (required)</label>
