  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <h2>Consumer Login Page..! </h2>
          <p>&nbsp;</p>
          <div class="clr"></div>
           
        
          
          <p><form action="authentication.jsp?type=<%="consumer"%>" method="post" id="leavereply">
            <ol>
              <li>
          ...
          <p align="right" class="style2">New <strong><a href="c_Register.jsp">Register</a></strong> </p>
          <div class="clr"></div>
        </div>
      </div>
      <div class="sidebar">
