    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="c_Profile.jsp">My Profile</a></li>
            <li><a href="c_SearchImages.jsp">Search Image Files</a></li>
			<li><a href="c_Download.jsp">Download Image Files</a></li>
			<li><a href="c_MySearch.jsp">My Search History</a></li>
