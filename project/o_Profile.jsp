...
<td  width="182" align="left" valign="middle" height="28"><div align="left" class="style6" style="margin-left:20px;"><%out.println(s4);%></div></td>
					...
					<tr>
					  <td   width="127" align="left" valign="middle" height="33" style="color: #2c83b0;"><div align="left" class="style3 style4 style14 style7" style="margin-left:20px;"><strong>Status</strong></div                        ></td>
