    ...
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          ...
          <p><h2><span class="style4"><%=request.getParameter("name")%></span> Digital Sign is <span class="style4"><%=request.getParameter("mac")%></span></h2>
          </p>
          <%
		  ...
		  {	  
		  %>
          <p align="right"><a href="w_ViewImageFiles.jsp">Back</a></p>
          <%}
		  else{
		  %>
          <p align="right"><a href="w_AllAttackers.jsp">Back</a></p>
		 <%}%>
