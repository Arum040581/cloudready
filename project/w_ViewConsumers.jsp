...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="clr"></div>
      <div class="logo">
        <h1><a href="index.html" class="style1">Statistics Extraction in Malicious SituationsS</a></h1>
      </div>
      <div class="clr"></div>
        <div class="clr"></div>
      </div>
        ...
        <div class="article">
          ...
          <p>  <table width="631" border="1"  cellpadding="0" cellspacing="0"  ">
            <tr>
              ...
              <td  width="108" valign="baseline" height="34" style="color: #2c83b0;"><div align="center" class="style15 style4 style5">UserImage</div></td>
